    ...
    <div className='app__contribute'>
        ...
        <div className="app__contribute_text">
            ...
            <div className="app__contribute_content">
                ...
                <p>This folder should have the title of your blog post. And should be in the "posts" folder. <a href="https://github.com/LearnDev-Foundation/how-to-blog/blob/main/posts/sample" target="_blank">Here</a> is a sample submission.</p>
