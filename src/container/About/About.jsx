    ...
    <div className='app__about'>
        ...
        <div className="app__about_text">
            ...
            <div className="app__about_content">
                ...
                <p>We are committed to providing a supportive and inclusive learning environment for all of our students. We welcome individuals from diverse backgrounds and strive to create an environment where everyone feels valued and respected.</p>
