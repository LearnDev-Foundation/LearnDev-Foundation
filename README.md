...
![GitHub license](https://img.shields.io/github/license/LearnDev-Foundation/learndev-foundation?style=plastic) [![Contributor Covenant](https://img.shields.io/badge/Contributor%20Covenant-2.1-4baaaa.svg)](code_of_conduct.md) [![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg?style=plastic)](https://makeapullrequest.com)

## Installation

This project is built using `Vite`. To install it use the following commands:

```bash
git clone https://github.com/LearnDev-Foundation/learndev-foundation.git

cd learndev-foundation
